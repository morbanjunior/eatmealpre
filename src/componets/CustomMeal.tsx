...
import { CartModel, custumMealModel} from '../model/CartModel'


const CustomMeal = () => {
//JSON.stringify("Select Protein")
  const [selectProtein, SetselectProtein] = useState<string>('Select Protein');
  const [selectSideOne, SetsSideOne] = useState<string>('Select Side 1');
  const [selectTwo, SetselectTwo] = useState<string>('Select Side 2');
  const [selectPriceProtein, SetselectPriceProtein] = useState<number>(0);
  const [selectPriceSideOne, SetselectPriceSideOne] = useState<number>(0);
  const [selectPriceSideTwo, SetselectPriceSideTwo] = useState<number>(0);
  const [multipleProtein, SetmultipleProtein] = useState<number>(0)
  const [multipleSideOne, SetmultipleSideOne] = useState<number>(0)
  const [multipleSideTwo, SetmultipleSideTwo] = useState<number>(0)
  const [selectColorProtein, SetselectColorProtein] = useState<number>(0);
  const [selectColorideOne, SetselectColorideOne] = useState<number>(0);
  const [selectColorSideTwo, SetselectColorSideTwo] = useState<number>(0);
  ...
  const itemm = 
      ...
      imgen_url: '',
      price: selectPriceProtein + selectPriceSideOne + selectPriceSideTwo,
    ...
    name: selectProtein + ", " + selectSideOne + ", " + selectTwo,
    price: selectPriceProtein + selectPriceSideOne + selectPriceSideTwo,
    desc: 'Protein: '+ multipleProtein + ", " + 'Side 1: ' + multipleSideOne + ', ' + 'Side 2: ' + multipleSideTwo ,
...
// price: parseFloat(selectPriceProtein + selectPriceSideOne + selectPriceSideTwo).toFixed(2),
  ...
  const selectedItems = () => {
    ...
    const optionsSelectProtein:custumMealModel[] = [
      ...
      const optionsSideOne:custumMealModel[] = [
      ...
      const optionsSideTwo:custumMealModel[] = [
...
//Funcion set price
    ...
    const handlePrice = (item:custumMealModel, index:number, selector:string) =>{
      if(selector==='protein'){
                ...
                <div className={styles.spanConstainerOz}>
                 ...
                 <div className={styles.totalCustomContainer}>
                    <div className={styles.totalCustomContainerTotal}>
                      ...
                      <span className={styles.totalCustom}>${selectPriceProtein + selectPriceSideOne + selectPriceSideTwo}</span>
                   ...
                   <div className={styles.buttonControl}>
                       ...
                       <span onChange={(
                         ...
                         ): void => SetQuantity(parseInt(e.target.value))} className={styles.inputCustom}>{quantity}</span>
                  ...
                  <div className={styles.customContainerRight}>
                     <div className={styles.rightCustom}>
                        ...
                        <div style={{ marginTop: '10px', display: 'flex', flexWrap: 'wrap'}}>
                          <div className={styles.categoriesTableItems}>
...
<>
                  <div className={styles.customContainerRight} style={{backgroundColor: '#1EAD5E'}}>
                     <div className={styles.rightCustom}>
                        ...
                        <div style={{ marginTop: '10px', display: 'flex', flexWrap: 'wrap'}}>
                          <div className={styles.categoriesTableItems} style={{backgroundColor: '#fff'}}>
