...
const Cart = () => {
  ...
  const itemMeals = useSelector((state) => state.cart.cartItems);
  ...
  const [choiceContainer,SetChoiceContainer] = useState(parseFloat(1.00).toFixed(2));
  ...
  const [bag,SetBag] = useState(parseFloat(10.00).toFixed(2));
  const [bagOptions,SetbagOptions] = useState(false);

  const [pMembership,SetPmembreship] = useState(parseFloat(139.99).toFixed(2));
  ...
  const [deliveryCharge, SetDeliveryCharge] = useState(parseFloat(9.99).toFixed(2));
            ...
            <div className={styles.containerCenter}>
                    ...
                    <img src={meal2}  alt=''  className={styles.ImgShop}/>
                       <div onChange={onChangeValue}>
                         <Radio defaultChecked
                          ...
                          <label className={styles.checkLabel} for="plastic" >Plastic</label>
                        </div>
                    </div>
                ...
                <div className={styles.iconshopLeftSideContainer}> 
                    ...
                    <span className={styles.checkLabelP}>
                      ...
                      Total Foods Count: 8
                       ...
                       <Checkbox 
                          ...
                          />
                          <label className={styles.checkLabel} for="plastic" >Use Existing Bag</label>
                        </div>
                    </div>
                 ...
                 <Checkbox 
                          ...
                          />
                      <div className={styles.bagContainertBody}>
                          <label className={styles.checkLabel} for="plastic" >Activate Prime Membership</label>
                 ...
                 <div className={styles.bagmembershipBody}>
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    ...
                    <div className={styles.imgshoDigitalWtSideContainer}>
                      ...
                      <span className={styles.checkLabel} checkLabelTwo>Balance: $100.25</span>
                      </div>
                      <div>
                      <div>
                      <Checkbox 
