    ...
    <div className={styles.centerTotalRight}>
            <div className={styles.headerContainerWallet}>
                              <div className={styles.imgContainerWallet}>
                                  ...
                                  <span></span>
                                  <span></span>
                                  <span className={walletItem.transType== "add" ? styles.totalWalletadd : styles.totalWalletless}>{walletItem.transType== "add" ? add : less} ${parseFloat(walletItem.amount).toFixed(2)}</span>
                              </div>
